...
public class TestProvider extends AndroidTestCase {
    ...
    /**
        Note that this test will work with the built-in (default) provider implementation,
        which just inserts records one-at-a-time, so really do implement the BulkInsert
